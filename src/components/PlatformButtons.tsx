...
const PlatformButtons = () => {
  ...
  return (
    <div className="flex flex-wrap justify-center gap-6 mb-12 w-full max-w-6xl mx-auto px-4">
      {platforms.map((platform, index) => (
        <motion.a
          href={platform.url}
          key={index}
          className="group relative flex-1 min-w-[240px] max-w-[280px] overflow-hidden"
