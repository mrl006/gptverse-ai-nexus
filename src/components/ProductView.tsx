  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-[#040812] pointer-events-none">
        {/* Enhanced glassmorphism elements with green glow */}
        ...
        <div className="absolute inset-x-0 bottom-0 h-px bg-gradient-to-r from-transparent via-[#0ef34b]/40 to-transparent"></div>
      </div>
      
      <div className="max-w-[1400px] mx-auto px-4 relative z-10">
        <div className="text-center mb-10">
          <h2 className="heading-gradient text-3xl md:text-4xl lg:text-5xl mb-3">EXPLORE OUR PRODUCTS</h2>
          <p className="text-white/70 max-w-2xl mx-auto">
            Discover our cutting-edge AI tools designed to enhance your digital experience
          </p>
        </div>
        ...
        <div className={`grid ${isMobile ? 'grid-cols-1 gap-4' : 'grid-cols-[280px,1fr] gap-6'}`}>
          ...
          <div className={`${isMobile ? 'min-h-[500px]' : 'min-h-[600px]'} w-full`}>
            <motion.div 
              className="glass-card p-4 md:p-6 backdrop-blur-xl border border-[#0ef34b]/20 bg-[#06101a]/40 rounded-2xl overflow-hidden h-full shadow-lg relative"
