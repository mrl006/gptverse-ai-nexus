...
const AboutBackground: React.FC = () => {
  return (
    <div className="absolute inset-0 pointer-events-none">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-[#040812] via-[#040812] to-[#040812]"></div>
      ...
      <div className="absolute top-[30%] right-[25%] w-[6px] h-[6px] rounded-full bg-[#0ef34b]/40 animate-float"></div>
      <div className="absolute top-[70%] left-[30%] w-[4px] h-[4px] rounded-full bg-[#0ef34b]/40 animate-float-slow"></div>
      <div className="absolute bottom-[40%] right-[40%] w-[8px] h-[8px] rounded-full bg-[#00aeff]/40 animate-float"></div>
