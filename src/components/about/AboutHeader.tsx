...
const AboutHeader: React.FC = () => {
  ...
  return (
    ...
    >
      <h2 className="text-[#0ef34b] uppercase tracking-wider text-xs md:text-sm font-mono mb-1">Quantum Hub</h2>
      <div className="relative inline-block">
        <h3 className="text-lg md:text-4xl font-bold mb-1 md:mb-4 relative z-10">
          NEURAL CORE
        </h3>
