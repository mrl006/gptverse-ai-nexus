...
const AboutHeader: React.FC = () => {
  ...
  return (
    ...
    >
      <h2 className="text-[#0ef34b] uppercase tracking-wider text-xs md:text-sm font-mono mb-2">Quantum Hub</h2>
      <div className="relative inline-block">
        <h3 className="text-xl md:text-4xl font-bold mb-2 md:mb-4 relative z-10 tracking-wide">
          NEURAL CORE
        </h3>
      ...
      <p className="text-xs md:text-sm text-white/70 max-w-md mx-auto">
        Advanced AI processing center with quantum computing capabilities
      </p>
    </motion.div>
  );
};
