  ...
  return (
    ...
    >
      <div className="relative max-w-md mx-auto h-full flex items-center">
        ...
        <div className="relative glass-card p-4 md:p-8 rounded-2xl border border-[#0ef34b]/20 overflow-hidden group h-full flex flex-col justify-center">
          ...
          {/* Floating Data Points - Hidden on small mobile */}
          {!isMobile && (
            <div className="absolute right-3 md:right-6 top-1/3 flex flex-col gap-2 md:gap-3">
              <div className="p-1.5 md:p-2 glass-card flex gap-1 md:gap-2 items-center rounded-lg border border-[#0ef34b]/20 text-xs md:text-sm animate-pulse-slow">
                <Zap className="w-3 h-3 md:w-4 md:h-4 text-[#0ef34b]" />
                <span>Neural Interface</span>
              </div>
              <div className="p-1.5 md:p-2 glass-card flex gap-1 md:gap-2 items-center rounded-lg border border-[#00aeff]/20 text-xs md:text-sm animate-pulse-slow" style={{
                animationDelay: '1s'
              }}>
                <Network className="w-3 h-3 md:w-4 md:h-4 text-[#00aeff]" />
                <span>Quantum Core</span>
              </div>
              <div className="p-1.5 md:p-2 glass-card flex gap-1 md:gap-2 items-center rounded-lg border border-[#d946ef]/20 text-xs md:text-sm animate-pulse-slow" style={{
                animationDelay: '2s'
              }}>
                <CheckCircle className="w-3 h-3 md:w-4 md:h-4 text-[#d946ef]" />
