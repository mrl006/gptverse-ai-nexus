  ...
  return (
    ...
    >
      ...
      <p className="text-white/80 text-sm leading-relaxed">
        GPTVerse bridges blockchain technology with AI solutions, delivering MVP-ready products and a robust innovation roadmap.
      </p>
      ...
      <div className="space-y-3">
        <div className="flex items-start gap-3 p-2 hover:bg-[#06101a]/60 rounded-lg transition-all">
          <div className="p-2 rounded-full bg-[#06101a]/60 border border-[#0ef34b]/30 shadow-lg shadow-[#0ef34b]/10">
            <CheckCircle className="w-4 h-4 text-[#0ef34b]" />
          </div>
          <div>
            <h4 className="font-semibold text-base text-white">First on BNB Chain</h4>
            <p className="text-white/70 text-xs">Pioneering contract on BNB Chain with multichain expansion plans</p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-3 p-2 hover:bg-[#06101a]/60 rounded-lg transition-all">
          ...
          <div>
            <h4 className="font-semibold text-base text-white">Expert Team</h4>
            <p className="text-white/70 text-xs">Backed by developers with 20+ years of industry experience</p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-3 p-2 hover:bg-[#06101a]/60 rounded-lg transition-all">
          ...
          <div>
            <h4 className="font-semibold text-base text-white">MVP Solutions</h4>
            <p className="text-white/70 text-xs">Launch-ready AI products delivering value across platforms</p>
          </div>
        </div>
      </div>
