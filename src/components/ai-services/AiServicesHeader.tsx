...
const AiServicesHeader: React.FC = () => {
  ...
  return (
    ...
    >
      <h2 className="text-[#0ef34b] uppercase tracking-wider text-xs md:text-sm font-mono mb-2">Quantum Tools</h2>
      <div className="relative inline-block">
        <h3 className="text-3xl md:text-5xl font-bold mb-4 md:mb-6 relative z-10">
          AI FORGE
        </h3>
