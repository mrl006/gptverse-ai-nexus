  ...
  return (
    <div className="text-center mb-16 relative">
      <div className="flex flex-col items-center">
        ...
        <h2 className="text-4xl md:text-5xl font-bold mb-3 heading-gradient">
        ...
        <div className="relative">
          ...
          <div className="absolute -bottom-3 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#0ef34b]/30 to-transparent"></div>
        </div>
      </div>
    </div>
  );
