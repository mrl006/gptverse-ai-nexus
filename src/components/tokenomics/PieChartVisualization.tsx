  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center">
      <div className="w-full h-[500px] max-w-[800px] mx-auto relative">
        ...
        {/* Centered indicator */}
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center backdrop-blur-lg bg-white/5 p-3 rounded-full border border-white/10 w-32 h-32 flex items-center justify-center">
          <div>
            <div className="text-white/90 font-mono text-sm mb-1">Total Supply</div>
