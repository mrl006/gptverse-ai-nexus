...
>(({ className, variant = "glassy", ...props }, ref) => (
  <div
    ...
    className={cn(
      ...
      variant === "glassy" && "bg-white/10 backdrop-blur-xl border-white/20 text-white shadow-[0_0_20px_rgba(0,0,0,0.2)] transition-all duration-500 group hover:border-white/30",
      className
    )}
    {...props}
  />
